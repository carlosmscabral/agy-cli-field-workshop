...
> 모듈을 시작하기 전에 이 과정을 완료하세요. 약 15분이 소요됩니다.
...
- **SSH / 원격 세션:** 브라우저에 붙여넣을 URL을 출력하며, 이후 인증 코드를 터미널에 다시 붙여넣습니다.
...
프로젝트 구성 파일(settings.json, mcp.json 등)과 함께 `.agents/` 폴더가 생성된 것을 볼 수 있습니다.
