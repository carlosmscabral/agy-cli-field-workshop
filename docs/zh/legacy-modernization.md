...
该面板显示所有正在运行的子代理及其状态：`running`、`done`、`killed`。观察这三个子代理同时完成。
...
> 📖 来源：[技能](https://antigravity.google/docs/skills) · [cli-features — /skills](https://antigravity.google/docs/cli-features) — uid 5_251–5_253
