...
> **Duration:** 20 min | **Module:** 1 — SDLC Productivity
...
Notice how `agy` matches your keywords, activates the `project-advisor-skill`, and directly references yourguidelines (such as Single Responsibility, Boundary Validation, and specific Error Catching) in its proposal!
