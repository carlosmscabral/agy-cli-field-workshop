...
Refer to [`samples/hooks/secret-scanner.sh`](https://github.com/carlosmscabral/agy-cli-field-workshop/blob/main/samples/hooks/secret-scanner.sh) as a template for the decision pattern.
