...
> **Workshop Use:** Practice exercise for [Module 2 — Legacy Codebase Modernization](../docs/legacy-modernization.md). Demonstrates the large-context codebase investigation pattern, AGENTS.md self-onboarding, and how agy handles mechanical namespace migrations that are error-prone for humans.
